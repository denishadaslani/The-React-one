...
import { signOutAsync } from '../../services/action/autentication';
                    ...
                    <div className="col-4 d-flex justify-content-end align-items-center">
                        ...
                        <div className="cart-button d-flex align-items-center mx-3 mt-2 ">
                            ...
                            <img src="./src/img/heart.png" alt="" className='mx-2' height={20} />
                             ...
                             {user && <Link to="/Addproduct" className="btn btn-success btn-sm mx-2">Add</Link>}
                            {!user ? (
                                <Link className="btn btn-warning" to="/signIn">SignIN</Link>
                            ) : (
                                <div><span>{user.email}</span> <button onClick={handleLogout}>Logout</button></div>
                            )}
                        </div>
                    </div>
                </Row>
